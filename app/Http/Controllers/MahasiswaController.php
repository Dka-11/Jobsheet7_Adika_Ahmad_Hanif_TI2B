...
class MahasiswaController extends Controller
{
    ...
    {
        $mahasiswa = Mahasiswa::all(); //Mengambil semua isi data
    ...
    {
        $Mahasiswa = Mahasiswa::where('nim', $Nim)->first(); //Menampilkan data dengan menemukan nim mahasiswa
